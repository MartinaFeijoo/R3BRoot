...
class R3BTrackingS522 : public FairTask
{
  public:
    ...
    void SetTofdCal(std::string const& cal_file) { tofd_fine = cal_file; }
    ...
    struct Track
    {
	    ...
	    double f30_y;
	    double f30_z;
	    double fvertex_mwpc_X;
	    double fvertex_mwpc_Y;
	    double f1_energy;
	    double last_x;
	    double last_z;
    };
    ...
    std::vector<Track> tracks_out2;//track candidates in FOOT
...
#define NOF_FIB_DET (DET_FI_LAST - DET_FI_FIRST + 1)
    ...
    const char* fDetectorNames[DET_MAX + 1] = {"EventHeader.", "Sci2Hit" , "Fi30Hit", "Fi31Hit", "Fi32Hit", "Fi33Hit",
	    "TofdHit", /*"FootCalData" ,*/"FootHitData", "Mwpc0HitData", "Mwpc1HitData", "LosHit", "FrsData", /****"NeulandCalData",***/ /*"NeulandHits", "NeulandClusters",*/ /****"CalifaCrystalCalData",****/ /*"CalifaClusterData",*/ NULL};
    ...
    Double_t tofdpar[44][3];
    std::string tofd_fine;
    Float_t  m0_X;
    Float_t  m0_Y;
    Float_t  m0_Z;
...
//    R3BTrack* AddTrackData(TVector3 mw, TVector3 poq, Double_t charge, Double_t aoz);
   R3BTrackS522* AddTrackData(TVector3 mw, TVector3 poq, Double_t charge, Double_t chargeout, Double_t aoz, Double_t ToF, Double_t FlightPath, TVector3 Angles, TVector3 outAngles, Int_t fiberid, TVector3 footAngles, TVector3 foot1pos, TVector3 foot2pos, TVector3 foot15pos, TVector3 foot16pos);
  public:
