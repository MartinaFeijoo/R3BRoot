...
class R3BTrackS522 : public TObject
{
  public:
    ...
    inline const TVector3 GetFootAngles() const { return fFootAngle; }
    inline const TVector3 GetFoot1Pos() const { return fFoot1Pos; }
    inline const TVector3 GetFoot2Pos() const { return fFoot2Pos; }
    inline const TVector3 GetFoot15Pos() const { return fFoot15Pos; }
    inline const TVector3 GetFoot16Pos() const { return fFoot16Pos; }
